        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td colSpan={3}>
                        <textarea value={qualifications} onChange={(e) => setQualifications(e.target.value)} style={{width:"100%"}}></textarea>
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <button disabled={!imageUpload} onClick={uploadImage}>Upload</button>
                    </td>
                    <td>
                        {imageURL ? (
                ...
                <tr>
                    <td><label>IRATA:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageIRATAUpload(event.target.files [0])}}/>
                        <button disabled={!imageIRATAUpload} onClick={uploadImageIRATA}>Upload</button>
                    </td>
                    <td>
                        {imageIRATAURL ? (
                ...
                <tr>
                    <td><label>Working at Heights:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageWorkingHeightsUpload(event.target.files [0])}}/>
                        <button disabled={!imageWorkingHeightsUpload} onClick={uploadImageWorkingHeights}>Upload</button>
                    </td>
                    <td>
                ...
                <tr>
                    <td><label>White Card:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageWhiteCardUpload(event.target.files [0])}}/>
                        <button disabled={!imageWhiteCardUpload} onClick={uploadImageWhiteCard}>Upload</button>
                    </td>
                    <td>
                        {imageWhiteCardURL ? (
                ...
                <tr>
                    <td><label>Trade 1:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageTradeOneUpload(event.target.files [0])}}/>
                        <button disabled={!imageTradeOneUpload} onClick={uploadImageTradeOne}>Upload</button>
                    </td>
                    <td>
                        {imageTradeOneURL ? (
                ...
                <tr>
                    <td><label>Trade 2:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageTradeTwoUpload(event.target.files [0])}}/>
                        <button disabled={!imageTradeTwoUpload} onClick={uploadImageTradeTwo}>Upload</button>
                    </td>
                    <td>
                        {imageTradeTwoURL ? (
                ...
                <tr>
                    <td><label>EWP:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageEwpUpload(event.target.files [0])}}/>
                        <button disabled={!imageEwpUpload} onClick={uploadImageEwp}>Upload</button>
                    </td>
                    <td>
                        {imageEwpURL ? (
                ...
                <tr>
                    <td><label>Drivers License:</label></td>
                    <td>
                        <input type="file" onChange={(event) => {setImageDriversLicenseUpload(event.target.files [0])}}/>
                        <button disabled={!imageDriversLicenseUpload} onClick={uploadImageDriversLicense}>Upload</button>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" onChange={(event) => {setImageSignatureUpload(event.target.files [0])}}/>
                        <button disabled={!imageSignatureUpload} onClick={uploadImageSignature}>Upload</button>
                    </td>
                    <td>
                        {imageSignatureURL ? (
